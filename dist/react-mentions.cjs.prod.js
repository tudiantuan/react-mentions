...
var makeTriggerRegex = function(trigger) {
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setContainerElement", function(el) {
      ...
      if (_this.props.hideSuggest) return null;
