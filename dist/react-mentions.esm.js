...
var MentionsInput = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(MentionsInput, [{
    ...
    value: function handlePaste(event) {
      ...
      var pastedMentions = event.clipboardData.getData('text/react-mentions').slice(0, this.props.maxLength);
      var pastedData = event.clipboardData.getData('text/plain').slice(0, this.props.maxLength);
